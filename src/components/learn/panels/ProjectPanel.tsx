      ...
      <div className="flex-1 overflow-y-auto p-5 space-y-6">
          ...
          <ol className="space-y-2">
            {project.milestones.map(m => (
              <li key={m.id} className={cn(
                ...
                m.status === "completed" && "bg-emerald-50 dark:bg-emerald-950/30",
        ...
        <section className="rounded-lg border p-4">
          ...
          <button
            ...
            className="mt-2 inline-flex items-center gap-2 rounded-md bg-amber-500/90 px-3 py-1.5 text-xs font-medium text-white hover:bg-amber-500 disabled:opacity-50"
          >
