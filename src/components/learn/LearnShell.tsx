  ...
  return (
    <div className="h-screen overflow-hidden flex flex-col bg-background text-foreground">
      ...
      <header className="h-12 border-b flex items-center gap-2 px-3 flex-shrink-0 bg-card">
        ...
        {/* XP chip */}
        {now && (
          <div className="inline-flex items-center gap-1.5 rounded-full bg-amber-500/10 px-3 py-1 text-xs font-medium text-amber-700 dark:text-amber-400">
        ...
        {/* Streak chip */}
        {now && (
          <div className="inline-flex items-center gap-1.5 rounded-full bg-orange-500/10 px-3 py-1 text-xs font-medium text-orange-700 dark:text-orange-400">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <nav className="w-[72px] border-r flex flex-col items-center py-3 gap-1.5 flex-shrink-0 bg-card">
          ...
          {now?.dailyTest.status === "in_progress" && (
            <div className="text-[9px] text-center text-amber-600 font-medium px-1">test<br/>open</div>
          )}
        </nav>
                ...
                {currentSlide ? (
                  <article className="space-y-4">
                    ...
                    {currentSlide.analogy && (
                      <div className="rounded-md border-l-4 border-amber-400 bg-amber-50 dark:bg-amber-950/30 p-3 text-sm">
                        <div className="text-[10px] font-semibold uppercase tracking-wide text-amber-700 dark:text-amber-400 mb-1">Analogy</div>
                        <p className="leading-relaxed">{currentSlide.analogy}</p>
                      </div>
                    )}

                    {currentSlide.realWorldExample && (
                      <div className="rounded-md border-l-4 border-emerald-400 bg-emerald-50 dark:bg-emerald-950/30 p-3 text-sm">
                        <div className="text-[10px] font-semibold uppercase tracking-wide text-emerald-700 dark:text-emerald-400 mb-1">Real-world example</div>
