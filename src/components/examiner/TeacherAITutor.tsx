...
/**
 * TeacherAITutor — AI Assistant chatbot for teachers.
 *
 ...
 *    dashboard's "Teacher Behavior" tab.
 *  - NO grading — purely assists the teacher.
 *
 * Backend: POST /api/ai/teacher-tutor
 */
...
export default function TeacherAITutor() {
  ...
  const send = async () => {
    ...
    try {
      const res = await api.post<{ reply: string }>("/api/ai/teacher-tutor", {
