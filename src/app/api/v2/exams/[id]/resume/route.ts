/**
 * GET /api/v2/exams/[id]/resume — L9 interrupted-session resume
 * (REDESIGN-P4 §2 L9, W5)
 *
 * Restores the exact question index + draft answers for an in-progress
 * exam. Never cached. 404 when the learner has no session for this exam.
 */

import { NextRequest } from "next/server";
import { getAuthUser } from "@/lib/auth";
import { apiSuccess, apiUnauthorized, apiError } from "@/lib/api-response";
import { getExamView, ExamError } from "@/modules/assessment/lib/exam-session-db";
