...
/** GET /api/admin/teacher-behavior — returns teacher AI Assistant sessions +
 ...
 *      (one row per AI Assistant turn), with the teacher's name/email/role.
 *    - summary: per-teacher aggregate (session count, last active, avg length,
 *      dominant language, engagement tier).
 *
 *  Admin-only (principal + administrator). Developer is excluded — teacher
