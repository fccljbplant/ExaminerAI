 ...
 *   - Only staff roles (teacher, TA, coordinator, counselor, admin) can access.
 *   - The system prompt is tuned for TEACHER needs: lesson prep, student
 ...
 *     so admins/principals can see teacher usage patterns + psych signals
