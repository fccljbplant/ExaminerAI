...
export async function PATCH(
  ...
  const VALID_ROLES = [
    "pending", "student", "teacher", "instructor", "course_coordinator",
  ...
  const ELEVATION_MATRIX: Record<string, string[]> = {
    administrator: ["pending", "student", "teacher", "instructor", "course_coordinator", "counselor", "guardian", "principal", "administrator", "demo"],
    principal: ["pending", "student", "teacher", "instructor", "course_coordinator", "counselor", "guardian", "principal", "administrator"],
  };
