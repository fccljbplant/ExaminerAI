...
export async function POST(req: NextRequest) {
  ...
  const auth = await requireRole([UserRole.INSTRUCTOR, UserRole.TEACHER, UserRole.TEACHING_ASSISTANT, UserRole.COURSE_COORDINATOR, UserRole.COUNSELOR, UserRole.DEMO]);
