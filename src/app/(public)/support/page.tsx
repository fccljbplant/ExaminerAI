    ...
    <div className="min-h-screen bg-bg text-fg">
      ...
      <section className="border-b border-line bg-bg-subtle/30">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 py-16 text-center">
          ...
          <p className="mt-3 text-fg-muted">Search our docs, contact support, or book a call.</p>
          <div className="mt-6 relative max-w-md mx-auto">
            <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-fg-muted" />
            <input
              type="text"
              placeholder="Search help articles..."
              className="w-full pl-9 pr-4 py-2.5 rounded-lg border border-line bg-bg text-sm focus:outline-none focus:ring-2 focus:ring-brand"
            />
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 py-16">
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <Card className="border-line">
            <CardHeader>
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-brand-subtle mb-2">
            ...
            <CardContent>
              ...
              <a href="mailto:support@traineesai.com" className="text-sm text-brand hover:underline">
          ...
          <Card className="border-line">
            ...
            <CardContent>
              ...
              <div className="space-y-1 text-sm">
                <Link href="/docs/BLUEPRINT" className="block text-brand hover:underline">Product Blueprint →</Link>
                <Link href="/docs/ARCHITECTURE" className="block text-brand hover:underline">Architecture →</Link>
                <Link href="/docs/UI-STANDARDS" className="block text-brand hover:underline">UI Standards →</Link>
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 py-16">
          ...
          <div className="space-y-6">
            {[
              ...
              <div key={faq.q} className="rounded-lg border border-line bg-surface p-4">
                <h3 className="font-semibold text-fg text-sm">{faq.q}</h3>
                <p className="mt-1.5 text-sm text-fg-muted leading-relaxed">{faq.a}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2 max-w-4xl mx-auto">
            <Card className="border-brand/30 bg-brand-subtle">
              <CardContent className="p-6">
                ...
                <p className="mt-1 text-sm text-fg-muted">Need to train 10+ engineers? Get a demo + pilot.</p>
            ...
            <Card className="border-line">
              <CardContent className="p-6">
                <GraduationCap className="h-8 w-8 text-brand mb-3" />
                <h3 className="font-bold text-lg">For Learners</h3>
                <p className="mt-1 text-sm text-fg-muted">Individual learner? Start free in under a minute.</p>
