...
export function V3Shell({ children, navGroups, userName, userInitials, roleSwitcher }: V3ShellProps) {
...
function V3Styles() {
  if (typeof document !== "undefined" && !document.getElementById("v3-css")) {
    ...
    .v3-topbar { height: 72px; background: rgba(255,255,255,.9); border-bottom: 1px solid var(--v3-border); display: flex; align-items: center; justify-content: space-between; padding: 0 34px; position: sticky; top: 0; z-index: 10; backdrop-filter: blur(10px); }
    ...
    .v3-page-title h1 { font-size: 28px; letter-spacing: -.7px; }
