...
export const DEFAULT_JOURNEY_STEPS = [
  ...
  },
  {
    ...
    description: "Install VS Code, Git, and your course tools. These are your tools for the course.",
    why: "A professional dev environment is your foundation. Setting it up correctly now prevents hours of frustration later.",
    action: { label: "Ask AI Tutor for help", mode: "ai-tutor", topic: "Setting up VS Code, Git, and your course development tools" },
    completedWhen: "manual",
    aiTutorTopic: "Setting up VS Code, Git, and course tools",
  },
  {
    id: "first-checkin",
    week: 1,
  ...
  },
  {
    ...
    description: "Homepage, databases, SQL. Your project starts taking shape.",
    ...
    aiTutorTopic: "Building a homepage with database fundamentals",
  },
  {
    id: "week3",
    week: 3,
    title: "Week 3: APIs, automation + AI agents",
    description: "REST APIs, automation, building your first AI agent.",
    ...
    aiTutorTopic: "REST APIs, automation, and building AI agents",
  },
  {
    id: "week4",
    week: 4,
  ...
  },
  {
    ...
    aiTutorTopic: "Software testing, security hardening, and deploying to live hosting",
  },
  {
    id: "week6",
    week: 6,
